...
<script src="<?= $RelBasePath ?>communs/tools?v<?=GepapirChangelog::getCurrentVersion()?>"></script>
<script>
...
HTML;
// DO NOT change above line indentation : otherwise it will cause a Parse Error
}
?>
