...
<p>Lorsque l'on veut publier des documents sur l'Internet, et sur le Web, il faut 
en passer par là&nbsp;: <abbr>HTML</abbr>, et depuis quelques années... <abbr>XHTML</abbr>. 
Est-ce que l'on doit abandonner <abbr>HTML</abbr> défintivement, quels sont 
les avantages liés à l'adoption de <abbr>XHTML</abbr>, que risque-t-on à 
cette migration&nbsp;? Voici quelques éléments de réponse...</p>
...
<ul>
	...
	<li>Le support pour MathML ou <abbr>SVG</abbr> est plus que réduit aujourd'hui - on 
	pourrait dire anecdotique. En ce qui concerne <abbr>SVG</abbr>, sans même parler de 
	support, Flash existe et on aura peut être plus avantage à utiliser ce 
	dernier.</li>
</ul>
...
<ul>
	...
	comme le [<a href="#whatwg">WhatWG</a>].</li>
</ul>
...
<h3>Mon site devra dans le futur être utilisé sur des périphériques mobiles 
(<abbr title="Personnal Digital Assistant">PDA</abbr>, GSM)</h3>

<p>Plusieurs types de terminaux mobiles&nbsp;:</p>

<ul>
	<li>Quant on parle de <abbr>GSM</abbr>, c'est à iMode ou WAP qu'il faut penser. iMode est basé 
sur des pages en <abbr>cHTML</abbr>, format propriétaire du créateur NTT Docomo. Quant au 
WAP, les pages sont en <abbr>WML</abbr>, ou éventuellement en <abbr>XHTML</abbr> Basic (mais il s'agit 
là de WAP 2, et le support est beaucoup plus réduit).</li>
	<li>Du côté des <abbr>PDA</abbr>, ce sont des navigateurs classiques - en particulier Internet 
Explorer sur Windows CE.</li>
	<li>Bien noter que les récents "smartphones" mèlent GSM et <abbr>PDA</abbr>, et rentrent donc 
dans les 2 catégories citées précédemment.</li>
</ul>

<p>Bref dans l'absolu on en revient aux points évoqués plus haut&nbsp;: soit on 
dispose d'un moteur de templates performant, soit les contenus sont stockés 
dans des pages statiques - auquel cas l'utilisation de <abbr>XHTML</abbr> 
facilitera les choses car on pourra se servir de <abbr>XSL</abbr>.</p>

<p>Cependant... Mettre à disposition des contenus et/ou des services à des 
clients mobiles (au sens large) implique une profonde réflexion&nbsp;: ce n'est pas 
simplement un changement de format (<abbr>XHTML</abbr> 
vers <abbr>WML</abbr> par exemple) dont il doit être question&nbsp;! Les usages et attentes seront 
en effet totalement différents&nbsp;! Il y a donc fort à parier que la raison vous 
pousse à développer plusieurs sites, suivant la nature du client utilisé.</p>
...
<p>La théorie, c'est beau, mais la pratique... Au jour d'aujourd'hui, le parc 
des navigateurs (et plus généralement agents utilisateur) installés étant ce 
qu'il est, il faut bien veiller aux points suivants si l'on veut publier en 
<abbr>XHTML</abbr> sur le Web.</p>
...
jusqu'à la v6 incluse, et visiblement ce sera <a href="http://blogs.msdn.com/ie/archive/2005/09/15/467901.aspx">aussi le cas pour la v7</a>) 
ne gère pas le type application/xml+xhtml... Vu la proportion d'utilisateurs 
de ce logiciel, <strong>l'utilisation d'un autre content-type que text/html, 
et donc de <abbr>XHTML</abbr> 1.1 est impossible sur le Web.</strong></p>
